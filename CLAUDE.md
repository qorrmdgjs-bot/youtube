...
1. **시리즈 비전 확정** — 한 가족 일대기 × 10개 핵심 사건 × 시점별 deep-dive = **18화** (당초 30화에서 조정. 시점은 dramatic peak에만 추가)
...
| 5 — IMF 거실의 어둠 | 1997 겨울 | ep9 | — | ep10 |
| 6 — 택시 운전석의 아버지 | 1999 가을 | ep11 | ep12 | — |
| 7 — 첫 월급 봉투 | 2005 겨울 | ep13 | — | ep14 |
| 8 — 결혼식 떨리는 손 | 2010 가을 | ep15 | ep16 | — |
| 9 — 스마트폰 묻는 아버지 | 2019 명절 | ep17 | — | — |
| 10 — 아버지의 택시 장부 | 2025 봄 | ep18 | — | — |

발행 순서: 사건 순(1→10), 시점 순(아들→아빠→엄마, 존재하는 것만). 주 5회 = 약 4주 분량.

## 시리즈 비전 (변경 불가)

- 한 가족(parent_sacrifice 5인) 30년 일대기를 18화 시리즈로
- 5분/편, 주 5회 발행
...
### ⏳ Phase 7 — 18화 본격 제작 + 발행

18화 순차 제작, [@loveu-fam](https://www.youtube.com/@loveu-fam) 채널. 시청 지속 시간 + POV 묶음 시청 비율 모니터링.
